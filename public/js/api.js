...
function getAppRootUrl() {
  const routeNames = new Set(['login', 'primeiro-acesso', 'cadastro-users', 'cadastro-usuarios', 'perfil', 'linktree', 'logistica', 'perguntas-palestra-1', 'questions-palestra-1', 'perguntas-palestra-2', 'questions-palestra-2', 'perguntas-palestra-3', 'questions-palestra-3', 'perguntas-palco-1', 'questions-palco-1', 'palco-1', 'perguntas-palco-2', 'questions-palco-2', 'palco-2', 'perguntas-palco-3', 'questions-palco-3', 'palco-3', 'perguntas-palco-4', 'questions-palco-4', 'palco-4', 'perguntas-palco-5', 'questions-palco-5', 'palco-5', 'moderacao-perguntas', 'questions-moderation', 'question-moderation', 'perguntas-aprovadas', 'questions-approved', 'qrcode-presenca-palco', 'questions-session-qrcode', 'checkin-presenca-palco', 'questions-session-checkin', 'teste', 'agenda', 'feed', 'estandes', 'scanner', 'scanner-kit', 'quiz']);

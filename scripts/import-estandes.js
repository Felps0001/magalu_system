...
const ESTANDES = [
  ...
  { nome: 'Acer' },
  { nome: 'Aiwa' },
  { nome: 'AOC', aliases: ['AOC (estande Philips | AOC)'] },
  { nome: 'Apple' },
  { nome: 'Araplac' },
  { nome: 'Atlas | Dako' },
  { nome: 'BenCorp' },
  ...
  { nome: 'Britânia', aliases: ['Britania', 'Britânia (estande Britânia | Philco)', 'Britania (estande Britania | Philco)'] },
  { nome: 'Caemmun' },
  { nome: 'Candide' },
  ...
  { nome: 'Oster / Cadence' },
  { nome: 'Oxford' },
  { nome: 'Philco', aliases: ['Philco (estande Britânia | Philco)', 'Philco (estande Britania | Philco)'] },
  { nome: 'Philips' },
  { nome: 'Philips Envision', aliases: ['Philips (estande Philips | AOC)'] },
  { nome: 'Philips Walita' },
  { nome: 'Plumatex' },
  ...
  { nome: 'Umaflex' },
  { nome: 'Wap' },
  { nome: 'Brastemp', aliases: ['Brastemp (estande Brastemp | Consul)'] },
  { nome: 'Consul', aliases: ['Consul (estande Brastemp | Consul)'] },
  { nome: 'BRTEST+' },
  { nome: 'Mercado Magalu' },
];
